...
void CalendarTest::testChinaSSE() {
	BOOST_TEST_MESSAGE("Testing China Shhanghai Securities Exchange holiday list...");
	std::vector<Date> expectedHol;

	// For the year 2014
	// http://www.gfhfzq.com.cn/review_cms_681840ec-1b86-4b96-9adb-509fff65e0ff.shtm
	expectedHol.push_back(Date(1, Jan, 2014));
	expectedHol.push_back(Date(31, Jan, 2014));
	expectedHol.push_back(Date(1, Feb, 2014));
	expectedHol.push_back(Date(2, Feb, 2014));
	...
	expectedHol.push_back(Date(8, Feb, 2014));
	expectedHol.push_back(Date(5, Apr, 2014));
	expectedHol.push_back(Date(6, Apr, 2014));
	...
	expectedHol.push_back(Date(1, Jun, 2014));
	expectedHol.push_back(Date(2, Jun, 2014));
	expectedHol.push_back(Date(6, Sep, 2014));
	expectedHol.push_back(Date(7, Sep, 2014));
	expectedHol.push_back(Date(8, Sep, 2014));
	expectedHol.push_back(Date(28, Sep, 2014));
	expectedHol.push_back(Date(1, Oct, 2014));
	expectedHol.push_back(Date(2, Oct, 2014));
	expectedHol.push_back(Date(3, Oct, 2014));
	expectedHol.push_back(Date(4, Oct, 2014));
	expectedHol.push_back(Date(5, Oct, 2014));
	expectedHol.push_back(Date(6, Oct, 2014));
	expectedHol.push_back(Date(7, Oct, 2014));
	expectedHol.push_back(Date(11, Oct, 2014));

	Calendar c = China(China::SSE);

	for(Size i=0; i<expectedHol.size();++i) {
		if(!c.isHoliday(expectedHol[i]))
			BOOST_FAIL("expected holiday " << expectedHol[i] << "is not recognized by " << c.name());
	}
}

void CalendarTest::testChinaIB() {
	BOOST_TEST_MESSAGE("Testing China Inter Bank working weekend list...");

	// http://finance.sina.com.cn/money/bond/20140102/104517821820.shtml
	std::vector<Date> expectedWorkingWeekEnd;

	expectedWorkingWeekEnd.push_back(Date(26, Jan, 2014));
	expectedWorkingWeekEnd.push_back(Date(8, Feb, 2014));
	expectedWorkingWeekEnd.push_back(Date(4, May, 2014));
	expectedWorkingWeekEnd.push_back(Date(28, Sep, 2014));
	expectedWorkingWeekEnd.push_back(Date(11, Oct, 2014));

	Calendar c = China(China::IB);

	for(Size i=0; i<expectedWorkingWeekEnd.size();++i) {
		if(c.isHoliday(expectedWorkingWeekEnd[i]))
			BOOST_FAIL("expected Working day " << expectedWorkingWeekEnd[i] << "is not recognized by " << c.name());
	}
}
