...
namespace QuantLib {
    ...
    */
	...
	public:
		CTBZeroBondHelper(const Handle<Quote>& cleanPrice,
			Natural settlementDays,
		...
		boost::shared_ptr<CTBZeroBond> ctbZeroBond() const;

		void accept(AcyclicVisitor&);

	protected:
		boost::shared_ptr<CTBZeroBond> ctbZeroBond_;
	...
	public:
		CTBFixedBondHelper(const Handle<Quote>& cleanPrice,
			const Date& issueDate,
			Natural settlementDays,
			Real faceAmount,
		...
		boost::shared_ptr<CTBFixedBond> ctbFixedBond() const;
	...
	inline boost::shared_ptr<CTBZeroBond>
		CTBZeroBondHelper::ctbZeroBond() const {
			return ctbZeroBond_;
	}

	inline boost::shared_ptr<CTBFixedBond>
