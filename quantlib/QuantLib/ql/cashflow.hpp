    ...
    */
    class CashFlow : public Event {
      public:
		...
		virtual void setDate(const Date& newDate) {
			QL_FAIL("Set date is not implemented for this kind of cash flow");
		}
        ...
        */
		...
		virtual void setAmount(Real newAmount) {
			QL_FAIL("Set amount is not implemented for this kind of cash flow");
		}
