...
namespace QuantLib {
    ...
    class Pool {
      public:
        ...
        void setTime(const std::string& name, Real time, const DayCounter& dc = ActualActual(ActualActual::ISMA), Date refDate = Date());
		Date getDate(Real time, const DayCounter& dc = ActualActual(ActualActual::ISMA), Date refDate = Date());
