...
export_discount_curve(LogLinearDiscountCurve,LogLinear);

// add interpolations as you wish, e.g.,
export_discount_curve(LinearDiscountCurve,Linear);
export_discount_curve(CubicDiscountCurve,Cubic);
export_discount_curve(BackwardFlatDiscountCurve,BackwardFlat);
export_discount_curve(ForwardFlatDiscountCurve,ForwardFlat);
