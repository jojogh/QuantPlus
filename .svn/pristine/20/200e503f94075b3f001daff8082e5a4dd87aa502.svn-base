...
namespace QuantLib {
    ...
    */
	...
	/*! Rational approximation offered by Minqiang Li
	    You Don't Have to Bother Newton for Implied Volatility, 2006, SSRN
	*/
    ...
    */
	...
	public:
		...
		static Real blackFormula(Option::Type optionType,
			...
			Real discount = 1.0,
			Real displacement = 0.0) {
				return QuantLib::blackFormula(optionType, strike, forward, stdDev, discount, displacement);
		}
		...
		static Real blackFormulaImpliedStdDevRA(Option::Type optionType,
			...
			Real accuracy = 1.0e-6,
			Natural maxIterations = 100) {
				return QuantLib::blackFormulaImpliedStdDevRA(optionType,
					strike,
					forward,
					blackPrice,
					discount,
