...
export_forward_curve(BackwardFlatForwardCurve,BackwardFlat);

// add interpolations as you wish, e.g.,
export_forward_curve(LinearForwardCurve,Linear);
export_forward_curve(CubicForwardCurve,Cubic);
export_forward_curve(LogLinearForwardCurve,LogLinear);
export_forward_curve(ForwardFlatForwardCurve,ForwardFlat);
