...
void CdoTest::testHW() {
    ...
    vector<pair<boost::shared_ptr<DefaultProbKey>,
           Handle<DefaultProbabilityTermStructure> > > probabilities;
    probabilities.push_back(std::make_pair(
        boost::make_shared<NorthAmericaCorpDefaultKey>(EURCurrency(),
                                   SeniorSec,
                                   Period(0,Weeks),
                                   10.),
    ...
    boost::shared_ptr<RandomDefaultModel> rdm(new
        GaussianRandomDefaultModel(pool,
                                   std::vector<boost::shared_ptr<DefaultProbKey> >(poolSize,
                                   boost::make_shared<NorthAmericaCorpDefaultKey>(EURCurrency(),
                                                               SeniorSec)),
                                   hCopula,
                                   1.e-6,
