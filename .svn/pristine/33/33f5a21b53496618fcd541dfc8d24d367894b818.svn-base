...
%{
	...
	typedef boost::shared_ptr<ShortRateModel> GeneralizedHullWhitePtr;
    typedef boost::shared_ptr<ShortRateModel> BlackKarasinskiPtr;
	typedef boost::shared_ptr<ShortRateModel> CoxIngersollRossPtr;
...
%rename(GeneralizedHullWhite) GeneralizedHullWhitePtr;
class GeneralizedHullWhitePtr : public boost::shared_ptr<ShortRateModel> {
  public:
    %extend {
	    GeneralizedHullWhitePtr(const Handle<YieldTermStructure>& termStructure,
                                Real a = 0.1, Real sigma = 0.01) {
			return new GeneralizedHullWhitePtr(
                new GeneralizedHullWhite(termStructure, a, sigma));
		}
		DiscountFactor discount(Time t) const {
            return boost::dynamic_pointer_cast<GeneralizedHullWhite>(*self)->discount(t);
	   }
	}
};
...
%rename(CoxIngersollRoss) CoxIngersollRossPtr;
class CoxIngersollRossPtr : public boost::shared_ptr<ShortRateModel> {
  public:
    %extend {
	    CoxIngersollRossPtr(Rate r0 = 0.05,
                            Real theta = 0.1,
                            Real k = 0.1,
                            Real sigma = 0.1) {
			return new CoxIngersollRossPtr(
			    new CoxIngersollRoss(r0, theta, k, sigma));
		}
	}
};
...
class ExtendedCoxIngersollRossPtr : public boost::shared_ptr<ShortRateModel> {
  public:
    %extend {
		ExtendedCoxIngersollRossPtr(const Handle<YieldTermStructure>& termStructure,
                                    Real theta = 0.1,
                                    Real k = 0.1,
                                    Real sigma = 0.1,
                                    Real x0 = 0.05) {
			return new ExtendedCoxIngersollRossPtr(
			    new ExtendedCoxIngersollRoss(termStructure, theta, k, sigma, x0));
		}
	}
};
