...
import org.CAL.BlackCalculator;
...
import org.CAL.GaussianPathGenerator;
import org.CAL.GaussianRandomSequenceGenerator;
import org.CAL.Option;
import org.CAL.Path;
import org.CAL.PlainVanillaPayoff;
import org.CAL.QuoteHandle;
import org.CAL.SamplePath;
import org.CAL.SimpleQuote;
import org.CAL.Statistics;
import org.CAL.TARGET;
import org.CAL.UniformRandomGenerator;
import org.CAL.UniformRandomSequenceGenerator;
import org.CAL.YieldTermStructureHandle;

/**
 * DiscreteHedging Test app - java version of CAL/Examples/DiscreteHedging
 * to illustrate use of CAL's MonteCarlo functionality through supplied
 * SWIG interfaces.
 *
...
public class DiscreteHedging {
     ...
     * support its implementation in Java while still relying upon CAL's
     * powerful RNGs.
     */
