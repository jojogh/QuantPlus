    ...
    class Bond : public Instrument {
      public:
        ...
        */
		...
		// OAS spread calculation
		// Assume that the curve handle will be used as discounting. This is very limited assumption 
		virtual Real optionAdjustedSpread(Real targetCleanPrice,
      ...
      protected:
		  Real priceErrorFromSpread(Real targetCleanPrice,
