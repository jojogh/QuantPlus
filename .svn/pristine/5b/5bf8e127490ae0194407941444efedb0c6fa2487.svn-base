...
namespace QuantLibAddin {
    ...
    std::vector<QuantLib::Rate> CALForwardsFromDiscountRatios(
    ...
    std::vector<QuantLib::Rate> CALCoterminalSwapRatesFromDiscountRatios(
                            const QuantLib::Size firstValidIndex,
                            const std::vector<QuantLib::DiscountFactor>& ds,
                            const std::vector<QuantLib::Time>& taus) {
    ...
    std::vector<QuantLib::Real> CALCoterminalSwapAnnuitiesFromDiscountRatios(
                            const QuantLib::Size firstValidIndex,
                            const std::vector<QuantLib::DiscountFactor>& ds,
                            const std::vector<QuantLib::Time>& taus) {
        std::vector<QuantLib::Real> rates(taus.size());
    ...
    std::vector<QuantLib::Rate> CALConstantMaturitySwapRatesFromDiscountRatios(
    ...
    std::vector<QuantLib::Real> CALConstantMaturitySwapAnnuitiesFromDiscountRatios(
                            const QuantLib::Size spanningForwards,
                            const QuantLib::Size firstValidIndex,
                            const std::vector<QuantLib::DiscountFactor>& ds,
                            const std::vector<QuantLib::Time>& taus) {
