...
namespace QuantLib {
	...
	class ShiborSwapRateHelper : public SwapRateHelper {

	public:
		ShiborSwapRateHelper(const Handle<Quote>& rate,
	...
	class IBFRSwapRateHelper : public RelativeDateRateHelper {

	public:
		IBFRSwapRateHelper(const Handle<Quote>& rate,
						   const Period& swapTenor,
						   Frequency payFreq,
		...
		Real impliedQuote() const;
		void setTermStructure(YieldTermStructure*);
		boost::shared_ptr<IBFRSwap> swap() const {
			return swap_;
		}
	...
	protected:
		...
		Frequency payFreq_;
		boost::shared_ptr<IborIndex> iborIndex_;
		boost::shared_ptr<IBFRSwap> swap_;
		RelinkableHandle<YieldTermStructure> termStructureHandle_;
		Handle<Quote> rateSpread_;
		Period fwdStart_;
		Handle<YieldTermStructure> discountHandle_;
		RelinkableHandle<YieldTermStructure> discountRelinkableHandle_;
	};
