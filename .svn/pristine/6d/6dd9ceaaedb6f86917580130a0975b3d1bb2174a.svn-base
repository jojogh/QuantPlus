...
namespace QuantLibAddin {
	...
	ShiborSwapRateHelper::ShiborSwapRateHelper(const boost::shared_ptr<ObjectHandler::ValueObject>& properties,
		const QuantLib::Handle<QuantLib::Quote>& rate,
		...
		: RateHelper(properties, permanent) {
			libraryObject_ = shared_ptr<QuantLib::RateHelper>(new
				QuantLib::ShiborSwapRateHelper(rate, swapTenor, 
				fixedFreq, shiborIndex,
				fwdStart, discountingCurve));
	}

	IBFRSwapRateHelper::IBFRSwapRateHelper(
		...
		: RateHelper(properties, permanent) {
			...
			libraryObject_ = shared_ptr<QuantLib::RateHelper>(new
				QuantLib::IBFRSwapRateHelper(rate, swapTenor, 
				payFreq, iborIndex, rateSpread, 
				fwdStart, discountingCurve));
	}
	...
	CTBFixedBondHelper::CTBFixedBondHelper(
		const boost::shared_ptr<ObjectHandler::ValueObject>& properties,
		const QuantLib::Handle<QuantLib::Quote>& cleanPrice,
		const QuantLib::Date& issueDate,
		QuantLib::Natural settlementDays,
    ...
    std::vector<string> CALRateHelperSelection(
