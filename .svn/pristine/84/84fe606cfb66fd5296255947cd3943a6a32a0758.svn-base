...
namespace QuantLibAddin {
    ...
    std::vector<QuantLib::Date> CALIMMNextDates(const QuantLib::Date& d,
                                               const std::vector<bool>& mainCycle);

    std::vector<std::string> CALIMMNextCodes(const QuantLib::Date& d,
                                            const std::vector<bool>& mainCycle);
    std::vector<QuantLib::Date> CALECBKnownDates();
}
