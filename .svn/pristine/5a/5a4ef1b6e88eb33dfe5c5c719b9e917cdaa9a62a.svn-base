...
class FixedRateBondTest(unittest.TestCase):
    ...
    def testFrequency(self):
        ...
        self.assertEqual(self.bond.frequency(), CAL.Semiannual)
    ...
    #    orig_date = CAL.Settings.evaluationDate
    #    CAL.Settings.evaluationDate = self.issue_date + 1*CAL.Months
    #    self.assertEqual(round(self.bond.settlementValue(100.0), 4), 102.3098)
    #    CAL.Settings.evaluationDate = orig_date
    ...
    def testPrevCoupon(self):
        ...
        self.assertEqual(self.bond.previousCouponRate(self.issue_date), 0.0)
